...
int main() {
    ...
    // std::vector<std::vector<int>> sccs4 = g19.tarjan_scc();
    // std::cout << "SCCs in graph 19\n";
    // for (auto scc : sccs4) {
    //     for (auto vertex : scc) {
    //         std::cout << vertex << " ";
    //     }
    ...
    // std::vector<std::vector<int>> sccs5 = g20.tarjan_scc();
    // std::cout << "SCCs in graph 20\n";
    // for (auto scc : sccs5) {
    //     for (auto vertex : scc) {
    //         std::cout << vertex << " ";
    //     }
    ...
    // std::vector<std::vector<int>> sccs6 = g21.tarjan_scc();
    // for (auto scc : sccs6) {
    //     for (auto vertex : scc) {
    //         std::cout << vertex << " ";
    //     }
    ...
    std::vector<std::vector<int>> sccs7 = g22.tarjan_scc();
    for (auto scc : sccs7) {
        for (auto vertex : scc) {
            std::cout << vertex << " ";
        }
    ...
    std::vector<std::vector<int>> sccs8 = g23.tarjan_scc();
    for (auto scc : sccs8) {
        for (auto vertex : scc) {
            std::cout << vertex << " ";
        }
